...
export type AnswerStatus = 'answered' | 'insufficient_evidence' | 'conflicting_evidence' | 'potentially_outdated' | 'needs_location' | 'official_judgment' | 'out_of_scope' | 'unavailable_source' | 'missing_geographic_coverage';
...
export function answerQuestion(question: string, options?: {sources?: Source[]; chunks?: Chunk[]; now?: Date | string | number}): ResidentAnswer;
